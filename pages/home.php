  ...
  <main class="main-content">
    ...
    <div class="highlight-section category-highlight">
      ...
      <div class="category-carousel">
        <a class="category-card sneakers-card" href="./catalog.php?category=Sneakers"><h3 class="category-name">Sneakers</h3></a>
        <a class="category-card running-card" href="./catalog.php?category=Running"><h3 class="category-name">Running</h3></a>
        <a class="category-card casual-card" href="./catalog.php?category=Casual"><h3 class="category-name">Casual</h3></a>
        <a class="category-card below100-card" href="./catalog.php?min-price=0&max-price=100"><h3 class="category-name">Below $100</h3></a>
      </div>
    </div>
    <!-- Footer -->
